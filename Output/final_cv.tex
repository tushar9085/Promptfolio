...
\begin{document}
 ...
 \begin{header}
    ...
    \AND%
    \kern 5.0 pt%
    \mbox{\hrefWithoutArrow{{website_url}}{{website_display}}}%
    \kern 5.0 pt%
    \AND%
    \kern 5.0 pt%
    \mbox{\hrefWithoutArrow{{linkedin_link}}{{linkedin_display}}}%
    \kern 5.0 pt%
    \AND%
    \kern 5.0 pt%
    \mbox{\hrefWithoutArrow{{github_link}}{{github_display}}}%
\end{header}
    ...
    \section{Education}
    \begin{twocolentry}{\textit{Rajshahi, Bangladesh}\\\textit{2014 – 2019}}
